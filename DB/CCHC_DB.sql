...
('admin', '123456', 'FAN Da Men', 'admin@cchc.hk', '12345678', 'ADMIN', NULL, 1),
...
-- 1. 診所資料
INSERT INTO clinics (name, address, phone, day_off, open_time, lunch_break_start, lunch_break_end, close_time) VALUES
('Chai Wan Clinic', 'Shop 402, 4/F, New Jade Shopping Arcade, 233 Chai Wan Road, Chai Wan', '2555 1234', 'Mon', '09:00:00', '13:00:00', '14:00:00', '18:00:00'),
('Tseung Kwan O Clinic', 'G/F, Shop G20, Metro City Phase II, 8 Yan King Road, Tseung Kwan O', '2666 5678', 'Sat,Sun', '10:00:00', '13:30:00', '14:30:00', '19:00:00'),
('Sha Tin Clinic', 'Level 1, Shop 105, New Town Plaza Phase III, 18 Sha Tin Centre Street, Sha Tin', '2777 9012', 'Wed', '09:30:00', '13:00:00', '14:00:00', '18:30:00'),
('Tuen Mun Clinic', 'Shop 312, 3/F, K-Point, 1 Tuen Lung Street, Tuen Mun', '2888 3456', 'Sat,Sun', '08:30:00', '12:30:00', '13:30:00', '17:30:00'),
('Tsing Yi Clinic', 'Shop 45, U2 Level, Tsing Yi Station, Tsing Yi', '2999 7890', 'Sun', '09:00:00', '13:00:00', '14:00:00', '21:00:00');

-- 2. 服務資料
INSERT INTO services (service_name, description) VALUES 
('General Consultation', 'Routine medical check-up and consultation for common illnesses.'),
...
INSERT INTO clinics_services (clinic_id, service_id, quota) VALUES
-- 柴灣診所 (Clinic 1)
(1, 1, 30), -- 普通科 (30名額)
(1, 2, 10), -- 疫苗服務
(1, 4, 5), -- 兒科
...
INSERT INTO appointments (user_id, clinic_id, service_id, appointment_date, appointment_time, status, cancel_reason) VALUES
