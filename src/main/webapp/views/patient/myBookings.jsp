...
<body>
    <div class="container">
        <!-- Page Header -->
        <h2>
            📋 我的預約記錄 / My Bookings - <%= currentUser.getFullName() %>
        </h2>
        ...
        <% if (myBookings != null && !myBookings.isEmpty()) { %>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <span class="status-<%= ab.getStatus().toLowerCase() %>">
                            <%= ab.getStatus() %>
                        </span>
                    </td>
                    <td>
                        <%= ab.getCancelReason() != null ? ab.getCancelReason() : "-" %>
                    </td>
                    <td>
        ...
        <% } else { %>
            <!-- No Bookings Message -->
            <p>
                目前沒有任何預約記錄。 / You have no appointments yet.
            </p>
        <% } %>
