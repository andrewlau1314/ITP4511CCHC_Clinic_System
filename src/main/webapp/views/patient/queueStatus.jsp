...
<body>
    <div class="container">
        ...
        <div class="number-box">
            <%= currentNumber != null ? "Q" + String.format("%03d", currentNumber) : "目前無叫號 / No Number Being Called" %>
        </div>

        <!-- Next Number -->
        <h3>下一個號碼 / Next Number</h3>
        <div class="number-box">
            <%= nextNumber != null ? "Q" + String.format("%03d", nextNumber) : "目前無下一個號碼 / No Next Number" %>
        </div>

        <!-- Your Queue Number -->
        <h3>您的號碼 / Your Queue Number</h3>
        <div class="number-box my-number">
            <%= myQueueNumber != null ? myQueueNumber : "您尚未排隊 / You have not joined the queue" %>
        </div>
