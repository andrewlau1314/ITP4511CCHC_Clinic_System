...
<head>
    ...
    <style>
        ...
        .number { font-size:24px; font-weight:bold; color:#28a745; }
        .my-number { background:#ffc107; color:black; font-weight:bold; }
    </style>
</head>
<body>
    <div class="container">
        <h2>👀 各診所即日排隊狀態 / All Clinics Queue Status</h2>
        <p>目前時間：<%= new java.util.Date() %></p>

        <table>
            <tr>
                <th>診所 / Clinic</th>
                <th>目前等待人數 / Waiting</th>
            ...
            <tr>
                ...
                <td><%= q.getEstimatedWaitMin() %> 人</td>
                <td class="number"><%= q.getQueueNumber() != null && q.getQueueNumber().startsWith("Q") ? q.getQueueNumber() : "目前無排隊" %></td>
                <td>
                    <% 
